...
{
    public class FindActForCnotractDate : IQuery
    {
        ТЛЬготник тЛЬготник;

        public FindActForCnotractDate(ТЛЬготник тЛЬготник)
        {
        ...
        public string Query()
        {
            ...
            string query = @"declare @DR DateTime
                           ...
                           @" select ФлагНаличияАкта, НомерДоговора,ДатаАктаВыполненныхРабот from Договор
                             inner join Льготник
