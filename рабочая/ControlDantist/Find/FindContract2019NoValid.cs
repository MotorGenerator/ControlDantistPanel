...
{
    public class FindContract2019NoValid : IFindPerson
    {
        string numContract = string.Empty;

        public FindContract2019NoValid(string numContract)
        {
        ...
        public string Query()
        {
            string query = @"declare @numContract nchar(100) " +
                           ...
                           @" SELECT Договор.id_договор,Договор.НомерДоговора, Льготник.Фамилия, Льготник.Имя, 
                            ...
                            where Договор.ФлагПроверки = 'False'--and idFileRegistProgect is not null
