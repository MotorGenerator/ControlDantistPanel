...
{
    public class FindPerson2019 : IFindPerson
    {
        string personFamili = string.Empty;

        public FindPerson2019(string personFamili)
        {
        ...
        {
            // Для фильтрации договоров ипользуем договра прошедшие проверку в 2019 году поосновным таблицам помечаем как 2018.
