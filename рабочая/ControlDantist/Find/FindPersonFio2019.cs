...
{
    public class FindPersonFio2019 : IFindPerson
    {
        private string FirstName = string.Empty;
        private string Name = string.Empty;

        public FindPersonFio2019(string firstName, string name)
        {
        ...
        {
            // Года прошедшие проверку по основной таблице в 2019 году помечаем как 2018.
