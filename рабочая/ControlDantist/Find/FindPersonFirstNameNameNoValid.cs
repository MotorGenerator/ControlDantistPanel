...
{
    public class FindPersonFirstNameNameNoValid : IFindPerson
    {
        private string firsName, name;

        public FindPersonFirstNameNameNoValid(string firsName, string name)
        {
        ...
        public string Query()
        {
            string query = @"declare @FirstName nvarchar(150)
                              ...
                              inner join Льготник
                                ...
                                and(ДатаАктаВыполненныхРабот is not null) and(YEAR(ДатаАктаВыполненныхРабот) <> 1900) and Договор.flag2020 = 0
                    ...
                    where Фамилия = @FirstName and Имя = @Name and ДоговорAdd.ФлагПроверки = 0 and ДоговорAdd.ФлагАнулирован = 0 and ДоговорAdd.ФлагАнулирован = 0 and ДоговорAdd.flag2019AddWrite = 1
                    ...
                    where Фамилия = @FirstName and Имя = @Name and Договор.idFileRegistProgect > 0 and Договор.ФлагПроверки = 0 and Договор.flag2019AddWrite = 0 
                    group by Договор.id_договор, НомерДоговора, Льготник.Фамилия, Льготник.Имя, Льготник.Отчество, ЛьготнаяКатегория.ЛьготнаяКатегория,
        ...
        //                        select Договор.id_договор,НомерДоговора,Льготник.Фамилия,Льготник.Имя,Льготник.Отчество,ЛьготнаяКатегория.ЛьготнаяКатегория,
        //                        SUM(УслугиПоДоговору.Сумма) as Сумма,Договор.ДатаЗаписиДоговора,Договор.НомерРеестра,Договор.НомерСчётФактрура
        //                        ,Договор.logWrite from dbo.Договор
        //                        inner join Льготник
        //                        ON Договор.id_льготник = Льготник.id_льготник
        //                        inner join ЛьготнаяКатегория
        //                        ON Договор.id_льготнаяКатегория = ЛьготнаяКатегория.id_льготнойКатегории
        ...
        //                        group by Договор.id_договор,НомерДоговора,Льготник.Фамилия,Льготник.Имя,Льготник.Отчество,ЛьготнаяКатегория.ЛьготнаяКатегория,
        //                        Договор.ДатаЗаписиДоговора,Договор.НомерРеестра,Договор.НомерСчётФактрура,Договор.logWrite
        //                        union
        //                        select distinct Tab1.id_договор,Tab1.НомерДоговора,Tab1.Фамилия,Tab1.Имя,Tab1.Отчество,Tab1.ЛьготнаяКатегория,Tab1.Сумма,Tab1.ДатаЗаписиДоговора,Tab1.НомерРеестра,Tab1.НомерСчётФактрура,logWrite from(
        ...
        //ДоговорAdd.ДатаЗаписиДоговора,ДоговорAdd.ФлагПроверки from ЛьготникAdd
        //                              inner join ДоговорAdd
        //                              ON ДоговорAdd.id_льготник = ЛьготникAdd.id_льготник
        //                              inner join УслугиПоДоговоруAdd
        //                              ON УслугиПоДоговоруAdd.id_договор = ДоговорAdd.id_договор
        ...
        //ЛьготнаяКатегория.ЛьготнаяКатегория, ДоговорAdd.logWrite,ДоговорAdd.НомерРеестра,ДоговорAdd.НомерСчётФактрура, ДоговорAdd.ДатаЗаписиДоговора,ДоговорAdd.ФлагПроверки) as Tab1
        ...
        //                        where TabPerson.Фамилия = @FirstName and TabPerson.Имя = @Name and Tab1.ФлагПроверки = 0
        //                        union
        ...
        //                        TabPerson.Сумма
        //                        ,TabPerson.DateWriteLetter as ДатаЗаписиДоговора,TabPerson.НомерРеестра,TabPerson.НомерСчётФактрура,TabPerson.logWrite from(select Фамилия, Имя, Отчество, НомерДоговора, ДатаРождения, SUM(УслугиПоДоговоруAdd.Сумма) as Сумма, 
        ...
        //                        SUM(УслугиПоДоговору.Сумма) as Сумма, ЛьготнаяКатегория.ЛьготнаяКатегория, Договор.НомерРеестра, Договор.НомерСчётФактрура,
        //                        ДатаАктаВыполненныхРабот as ДатаПодписания, СуммаАктаВыполненныхРабот, ProjectRegistrFiles.DateWriteLetter, Договор.logWrite, Договор.ФлагПроверки
        ...
        //                        , Договор.logWrite
        //                        , Договор.ФлагПроверки, Договор.НомерРеестра, Договор.НомерСчётФактрура
        //                        ) as TabPerson
        //                        ON Tab1.Фамилия is null
        //                        where TabPerson.Фамилия = @FirstName and TabPerson.Имя = @Name and TabPerson.ФлагПроверки = 0 ";
