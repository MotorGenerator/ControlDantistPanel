...
namespace ControlDantist.Classes
{
    ...
    public class ErrorsReestrUnload
    {
        ...
        /// <summary>
        /// ќшибочное количество услуг
        /// </summary>
        public int ќшибка оличество
        {
            get
            {
                return ошибка оличество;
            }
            set
            {
                ошибка оличество = value;
            }
        }
        ...
        /// <summary>
        /// ”казывает что данный элемент коллекции уже попадалс€ при перечислении
        /// </summary>
