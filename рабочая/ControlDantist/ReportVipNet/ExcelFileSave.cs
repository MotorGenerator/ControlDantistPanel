...
{
    public class ExcelFileSave : IFile
    {
        // Флаг сохранения файла.
        private bool flagFileSave = false;
        ...
        public ExcelFileSave(List<Person> listPerson)
        {
            list = listPerson;
        }
        ...
        public void Save(string fileName)
        {
            try
            {
                ...
                WorksheetCell myCella01 = rowT01.Cells.Add("Список льготных катгорий граждан, получивших услуги по бесплатному зубопротезированию, за период с " + this.Period.Trim());
                myCella01.Index = 1;
                myCella01.MergeAcross = 13;
                myCella01.StyleID = "HeaderStyle2";
                ...
                foreach (var item in list)
                {
                    ...
                    WorksheetCell myCell = rowT.Cells.Add(item.Region);
                    myCell.Index = 1;
                    //cellFG.MergeAcross = 1;
                    myCell.StyleID = "HeaderStyle2";

                    WorksheetCell myCell2 = rowT.Cells.Add(item.City);
                    myCell2.Index = 2;
                    //cellFG.MergeAcross = 1;
                    myCell2.StyleID = "HeaderStyle2";

                    WorksheetCell myCell3 = rowT.Cells.Add(item.FirstName);
                    myCell3.Index = 3;
                    //cellFG.MergeAcross = 1;
                    myCell3.StyleID = "HeaderStyle2";

                    WorksheetCell myCell4 = rowT.Cells.Add(item.Name);
                    myCell4.Index = 4;
                    //cellFG.MergeAcross = 1;
                    myCell4.StyleID = "HeaderStyle2";

                    WorksheetCell myCell5 = rowT.Cells.Add(item.SecondName);
                    myCell5.Index = 5;
                    //cellFG.MergeAcross = 1;
                    myCell5.StyleID = "HeaderStyle2";

                    WorksheetCell myCell6 = rowT.Cells.Add(Convert.ToDateTime(item.DateBirth).ToShortDateString());
                    myCell6.Index = 6;
                    //cellFG.MergeAcross = 1;
                    myCell6.StyleID = "HeaderStyle2";

                    WorksheetCell myCell7 = rowT.Cells.Add(item.Street);
                    myCell7.Index = 7;
                    //cellFG.MergeAcross = 1;
                    myCell7.StyleID = "HeaderStyle2";

                    WorksheetCell myCell8 = rowT.Cells.Add(item.NumHous);
                    myCell8.Index = 8;
                    //cellFG.MergeAcross = 1;
                    myCell8.StyleID = "HeaderStyle2";

                    WorksheetCell myCell9 = rowT.Cells.Add(item.NumBobyBuilder);
                    myCell9.Index = 9;
                    //cellFG.MergeAcross = 1;
                    myCell9.StyleID = "HeaderStyle2";

                    WorksheetCell myCell10 = rowT.Cells.Add(item.NumApartment);
                    myCell10.Index = 10;
                    //cellFG.MergeAcross = 1;
                    myCell10.StyleID = "HeaderStyle2";

                    WorksheetCell myCell11 = rowT.Cells.Add(item.SeriesDoc);
                    myCell11.Index = 11;
                    //cellFG.MergeAcross = 1;
                    myCell11.StyleID = "HeaderStyle2";

                    WorksheetCell myCell12 = rowT.Cells.Add(item.NumDoc);
                    myCell12.Index = 12;
                    //cellFG.MergeAcross = 1;
                    myCell12.StyleID = "HeaderStyle2";

                    WorksheetCell myCell13 = rowT.Cells.Add(item.SumAct.ToString());
                    myCell13.Index = 13;
                    //cellFG.MergeAcross = 1;
                    myCell13.StyleID = "HeaderStyle2";

                    WorksheetCell myCell14 = rowT.Cells.Add(item.DateWriteAct.Date.ToShortDateString());
                    myCell14.Index = 14;
                    //cellFG.MergeAcross = 1;
