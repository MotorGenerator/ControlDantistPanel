...
{
    /// <summary>
    /// Проверка после 2019 года.
    /// </summary>
    public class ValidAfter2019 : IValidatePersonContract
    {
        ...
        public ValidAfter2019(string famili, string name, string secondName, DateTime dateBirth)
        {
        ...
        public string Execute()
        {
            this.query = @"declare @FirstName nvarchar(150)
			                    ...
			                    ,Договор.logWrite,Договор.flag2019AddWrite,2020 as Год,flagАнулирован from dbo.Договор
                              inner join Льготник
