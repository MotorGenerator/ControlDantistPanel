...
{
    /// <summary>
    /// Проверка до 2019 года по обычнам таблицам.
    /// </summary>
    public class ValidTo2019 : IValidatePersonContract
    {
        ...
        public ValidTo2019(string famili, string name, string secondName, DateTime dateBirth)
        {
        ...
        public ValidTo2019(PersonParametr personParametr)
        {
            this.famili = personParametr.famili;
            this.name = personParametr.name;
            this.secondName = personParametr.secondName;
            this.dateBirth = personParametr.dateBirth;
        }
        ...
        public string Execute()
        {
            this.query = @"declare @FirstName nvarchar(150)
                               ...
                               @" select Договор.id_договор,НомерДоговора,АктВыполненныхРабот.ДатаПодписания as ДатаПодписания,Льготник.Фамилия,Льготник.Имя,Льготник.Отчество,ЛьготнаяКатегория.ЛьготнаяКатегория,
			                    ...
			                    ,Договор.logWrite,Договор.flag2019AddWrite,2017 as Год,flagАнулирован from dbo.Договор
                              inner join Льготник
