...
namespace ControlDantist.ValidateRegistrProject
{
    public class ValidatePrefCategoryList2 : IEsrnValidate
    {
        ...
        public string FindPersons(string nameDocPreferentCategory)
        {
            ...
            string queryJoin =  @"select  " + nameTempTable + ".id_договор, OUID,Tab1.Фамилия,Tab1.Имя,Tab1.Отчество,DOCUMENTSTYPE,DOCUMENTSERIES,DOCUMENTSNUMBER,ISSUEEXTENSIONSDATE,A_NAME,A_ADRTITLE,BIRTHDATE,A_SNILS,A_REGREGIONCODE from( " +
